...
# ChatGPT의 중등 교육 활용 관련 <br>국내 연구 동향 분석 :  활동이론을 중심으로
...
---
### 1.2. 연구 문제
1.  활동이론으로 분석한 ChatGTP의 중등 교육 활용 관련 국내 문헌의 연구 동향은 어떠한가?  <!-- element style="font-size:32px"-->
2. ChatGPT의 중등 교육 활용 관련 국내 문헌에서 주요하게 언급된 키워드는 무엇인가?<!-- element style="font-size:32px"-->
3. 연구 동향 분석을 통해 도출할 수 있는 ChatGPT 활용 중등 교육에 관한 주요 연구주제와 시사점은 무엇인가? <!-- element style="font-size:32px" -->
...
<div class="src">출처 : OpenAI blog https://openai.com/blog </div>
